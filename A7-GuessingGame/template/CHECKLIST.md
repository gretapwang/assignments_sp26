...
YES 2 pts: Method followPath correctly returns the indicated node of a decision tree

YES 2 pts: Plays a game that moves correctly through the tree to a guess

YES 2 pts: Correctly updates tree when the program guesses wrong

YES This includes using the tree from the input file, writing updates back to the file, and preserving learned animals across replay and restart.
